    ...
    <header className="header page__header">
      ...
      <nav className="nav header__nav">
        <div className="nav__avatar-container nav__avatar-position" onClick={() => handleOpenPopup(editAvatarPopup)}>
          <img src="./images/odcenteno.webp" alt="Omar Daniel Photo" className="nav__avatar"></img>
        </div>
        <div className="nav__container">
          <div className="nav__name-edit">
            <h1 className="nav__name">Hi! My name is...
            </h1>
          ...
          <p className="nav__job-title">Viajero Intergaláctico</p>
        </div>
